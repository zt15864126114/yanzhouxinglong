...
const originalHealthList = ref<HealthItem[]>([
  ...
  { id: 3, serviceName: '视频监控', owner: '赵强', status: '异常', lastCheck: '2025-05-22 17:00', desc: '部分摄像头离线' },
  { id: 4, serviceName: '数据共享', owner: '孙丽', status: '正常', lastCheck: '2025-05-22 16:00', desc: '数据同步正常' },
  { id: 5, serviceName: '应急指挥', owner: '周伟', status: '正常', lastCheck: '2025-05-21 14:00', desc: '服务稳定' },
  { id: 6, serviceName: '资产管理', owner: '马俊', status: '异常', lastCheck: '2025-05-22 11:00', desc: '数据库连接失败' },
  { id: 7, serviceName: '工单系统', owner: '许静', status: '正常', lastCheck: '2025-05-18 09:00', desc: '无异常' },
  { id: 8, serviceName: '能耗监控', owner: '宋倩', status: '告警', lastCheck: '2025-05-18 13:00', desc: '能耗超阈值' },
  { id: 9, serviceName: '安全事件', owner: '魏东', status: '正常', lastCheck: '2025-05-19 10:00', desc: '无安全告警' },
  { id: 10, serviceName: '备份任务', owner: '冯媛', status: '正常', lastCheck: '2025-05-19 15:00', desc: '备份完成' }
])
